...
bool OTAUpdater::performUpdate(const char* firmwareUrl) {
    ...
    lv_obj_t* updating_label = lv_label_create(lv_scr_act());
    lv_label_set_text(updating_label, "Updating...");
    lv_obj_align(updating_label, LV_ALIGN_TOP_LEFT, 10, 20);
    
    lv_obj_t* warning_label = lv_label_create(lv_scr_act());
    lv_label_set_text(warning_label, "Do not power off");
    lv_obj_align(warning_label, LV_ALIGN_TOP_LEFT, 10, 40);
    ...
    lv_obj_align(success_label, LV_ALIGN_TOP_LEFT, 10, 30);
    ...
    lv_obj_align(fail_label, LV_ALIGN_TOP_LEFT, 10, 30);
